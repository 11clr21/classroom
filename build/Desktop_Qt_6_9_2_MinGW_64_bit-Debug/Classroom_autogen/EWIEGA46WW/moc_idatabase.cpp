...
void IDatabase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (IDatabase::*)()>(_a, &IDatabase::databaseConnected, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (IDatabase::*)(const QString & )>(_a, &IDatabase::databaseError, 1))
            return;
    }
}
...
// SIGNAL 0
void IDatabase::databaseConnected()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void IDatabase::databaseError(const QString & _t1)
{
