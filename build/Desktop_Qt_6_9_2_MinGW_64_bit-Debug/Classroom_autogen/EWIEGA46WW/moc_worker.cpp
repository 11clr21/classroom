...
template <> constexpr inline auto Worker::qt_create_metaobjectdata<qt_meta_tag_ZN6WorkerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'batchImportData'
        QtMocHelpers::SlotData<void(const QJsonArray &)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->batchImportData((*reinterpret_cast< std::add_pointer_t<QJsonArray>>(_a[1]))); break;
        case 2: _t->exportBigFile((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Worker::*)(bool , const QString & )>(_a, &Worker::workFinished, 0))
            return;
    }
}
...
// SIGNAL 0
void Worker::workFinished(bool _t1, const QString & _t2)
{
